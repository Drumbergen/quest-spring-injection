...
public class WizardController {
    ...
    @Autowired  // ANDI
    // ANDI orginal -> private WizardRepository repository = new WizardRepository();
    @Qualifier("wizardRepository")    //ANDI
    // private WizardDao repository = new WizardRepository(); // ANDI
    private WizardDao repository; // ANDI
